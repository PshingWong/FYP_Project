...
st.components.v1.html(open('en_content_visualization.html', 'r').read(), width=1400, height=900, scrolling=True)
st.components.v1.html(open('es_content_visualization.html', 'r').read(), width=1400, height=900, scrolling=True)
st.components.v1.html(open('fr_content_visualization.html', 'r').read(), width=1400, height=900, scrolling=True)
st.components.v1.html(open('pt_content_visualization.html', 'r').read(), width=1400, height=900, scrolling=True)
